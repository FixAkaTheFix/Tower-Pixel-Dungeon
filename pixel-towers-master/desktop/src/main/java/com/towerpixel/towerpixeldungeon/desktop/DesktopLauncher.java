...
package com.towerpixel.towerpixeldungeon.desktop;
...
import com.towerpixel.towerpixeldungeon.services.news.News;
import com.towerpixel.towerpixeldungeon.services.news.NewsImpl;
import com.towerpixel.towerpixeldungeon.services.updates.UpdateImpl;
	...
	public static void main (String[] args) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			public void uncaughtException(Thread thread, Throwable throwable) {
				...
				exceptionMsg = exceptionMsg.replace("com.towerpixel.towerpixeldungeon.", "");
