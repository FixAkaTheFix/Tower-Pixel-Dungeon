...
import com.fixakathefix.towerpixeldungeon.items.LostBackpack;
...
public class InterlevelScene extends PixelScene {
	...
	private void descend() throws IOException {
		...
		if (Dungeon.hero == null) {
			...
			Dungeon.init();
			GameLog.wipe();
			Dungeon.branch = GamemodeSelectionScene.chosenBranch;
			...
			curTransition = null;
			Dungeon.switchLevel( level, destTransition.cell() );//added the depth to prevent heroes from running away from their duties
		}
