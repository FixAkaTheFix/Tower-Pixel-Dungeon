...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_LETHALITY, null), "Ring Buffs",
	...
	public static void add_v0_7_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_DEMONICSKULLS), "Ally AI improvements",
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_ENERGY, null), "Other Item Buffs",
	...
	public static void add_v0_7_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_LETHALITY, null), Messages.get(RingOfWealth.class, "name"),
	...
	public static void add_v0_7_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new CampRatMageSprite(), "Hero Class changes",
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ELEMENTS, null), "Various Item Buffs",
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ARCANA, null), "Ring Nerfs",
	...
	public static void add_v0_7_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_STRENGTH, null), "Exotic Potions",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_HEART, null), "Exotic Scrolls",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_UPGRADE, null), new ScrollOfTeleportation().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_TERROR, null), new ScrollOfMirrorImage().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_BATTLECRY, null), new ScrollOfTerror().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_RECHARGE, null), new ScrollOfSkulls().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_STRENGTH, null), new PotionOfHealing().trueName(),
