...
public class v0_2_X_Changes {
	...
	public static void add_v0_2_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_STRENGTH, null), "Balance Changes",
	...
	public static void add_v0_2_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_TENACITY, null), "New Rings!",
