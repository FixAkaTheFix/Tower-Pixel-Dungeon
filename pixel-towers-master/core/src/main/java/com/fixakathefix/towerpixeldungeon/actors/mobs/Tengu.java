...
import com.fixakathefix.towerpixeldungeon.items.artifacts.LloydsBeacon;
import com.fixakathefix.towerpixeldungeon.items.bombs.Bomb;
import com.fixakathefix.towerpixeldungeon.levels.Level;
import com.fixakathefix.towerpixeldungeon.levels.PrisonBossLevel;
...
public class Tengu extends Mob {
	...
	public boolean useAbility(){
		...
		while (!abilityUsed){
			...
			} else if (false/*Dungeon.isChallenged(Challenges.STRONGER_BOSSES)*/) {
