...
public class v2_X_Changes {
	...
	public static void add_v2_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_ELEMENTS), "Item Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_ARCANA), "Smaller Item Nerfs",
