...
public class Hunger extends Buff implements Hero.Doom {
	...
	private static final float STEP	= 10f;//from 10

	public static final float HUNGRY	= 10000f;//I found how the remove this, but damm imagine a guy playing for 10k hours and literally getting hungry and the game reminds him of that
	public static final float STARVING	= 10010f;
