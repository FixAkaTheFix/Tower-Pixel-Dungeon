...
import com.fixakathefix.towerpixeldungeon.actors.mobs.npcs.NPC;
...
import com.fixakathefix.towerpixeldungeon.sprites.WardSprite;
...
public class WandOfWarding extends Wand {
	...
	public static class Ward extends NPC {
		...
		private void zap() {
			...
			//always hits
			int dmg = Random.NormalIntRange(
					Math.round(3*magicDamageModifier() +
					wandLevel*magicDamageModifier()),
					Math.round(6*magicDamageModifier() +
					2*wandLevel*magicDamageModifier()));
