...
public class v1_X_Changes {
	...
	public static void add_v1_4_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_FUROR), new RingOfArcana().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_LETHALITY), new RingOfWealth().trueName(),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_ARTIFACTRECHARGE), new ScrollOfHolyNova().trueName(),
	...
	public static void add_v1_3_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CHALLENGE_ON), "New Score System!",
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CHALLENGE_ON), "New Badges!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.EXOTIC_UNSPEAKABLE), Messages.get(ScrollOfMetamorphosis.class, "name"),
	...
	public static void add_v1_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.EXOTIC_HEART), "Exotic Reworks",
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.EXOTIC_STRENGTH), "Exotic Buffs",
