...
import com.fixakathefix.towerpixeldungeon.items.armor.curses.Bulk;
...
import com.fixakathefix.towerpixeldungeon.items.weapon.melee.Greataxe;
...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ELEMENTS, null), Messages.get(RingOfSharpshooting.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_ENERGY, null), Messages.get(RingOfElements.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_EVASION, null), new RingOfEvasion().trueName(),
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.POTION_MINDVISION, null), "Potion Adjustments",
	...
	public static void add_v0_6_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.CHALLENGE_ON), "Badge Changes",
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ELEMENTS, null), new RingOfEnergy().trueName(),
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_TENACITY, null), "Ring Mechanics Changes",
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_LETHALITY, null), new RingOfWealth().trueName(),
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ACCURACY, null), new RingOfMight().trueName(),
