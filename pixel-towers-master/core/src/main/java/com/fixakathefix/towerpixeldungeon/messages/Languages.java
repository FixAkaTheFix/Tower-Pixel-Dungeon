...
package com.fixakathefix.towerpixeldungeon.messages;

import java.util.Locale;

public enum Languages {
	ENGLISH("english",      "",   Status._COMPLETE_, null, null),
	CHINESE("中文",          "zh", Status.UNREVIEWED, new String[]{"_JDSA Ling_","Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"_JDSA Ling_","931451545", "Budding", "Chronie_Lynn_Iwa", "Fatir", "Fishbone", "Hcat", "HoofBumpBlurryface", "Horr_lski", "Lery", "Lyn_0401", "Ooooscar", "ShatteredFlameBlast", "SpaceAnchor", "Teller", "hmdzl001", "leo", "tempest102", "户方狸奴"});
