...
public class ItemSpriteSheet {
	...
	public static final int BONE_CLAYMORE = WEP_TIER3+2;
	...
	public static final int RING_LETHALITY = RINGS+8;
	public static final int RING_MIGHT = RINGS+9;
	public static final int RING_SHARPSHOOTING = RINGS+10;
	public static final int RING_TENACITY = RINGS+11;
	...
	public static final int ARTIFACT_BROKENHOURGLASS = ARTIFACTS+26;
	public static final int ARTIFACT_ROSESEED        = ARTIFACTS+27;
	static{
		assignItemRect(ARTIFACT_CLOAK,      9,  15);
		assignItemRect(ARTIFACT_ARMBAND,    16, 13);
		assignItemRect(ARTIFACT_CAPE,       16, 14);
		assignItemRect(ARTIFACT_TALISMAN,   14, 16);
		...
		assignItemRect(ARTIFACT_BROKENHOURGLASS,13,16);
		assignItemRect(ARTIFACT_ROSESEED,10,16);
	}
	...
	public static final int SCROLL_ANTIMAGIC = SCROLLS+2;
	public static final int SCROLL_MIRRORIMAGE = SCROLLS+3;
	public static final int SCROLL_RECHARGE = SCROLLS+4;
	public static final int SCROLL_TELEPORT = SCROLLS+5;
	public static final int SCROLL_DROWSINESS = SCROLLS+6;
	public static final int SCROLL_MAGICMAPPING = SCROLLS+7;
	public static final int SCROLL_BATTLECRY = SCROLLS+8;
	public static final int SCROLL_SKULLS = SCROLLS+9;
	public static final int SCROLL_TERROR = SCROLLS+10;
	public static final int SCROLL_TRANSMUTATION = SCROLLS+11;
	...
	public static final int EXOTIC_ENCHANTMENT = EXOTIC_SCROLLS+0;
	public static final int EXOTIC_GOLEMS = EXOTIC_SCROLLS+1;
	public static final int EXOTIC_BANISHMENT = EXOTIC_SCROLLS+2;
	public static final int EXOTIC_PRISMATIC = EXOTIC_SCROLLS+3;
	public static final int EXOTIC_ARTIFACTRECHARGE = EXOTIC_SCROLLS+4;
	public static final int EXOTIC_RATLEGION = EXOTIC_SCROLLS+5;
	public static final int EXOTIC_HEART = EXOTIC_SCROLLS+6;
	public static final int EXOTIC_DISCOVERIES = EXOTIC_SCROLLS+7;
	public static final int EXOTIC_CHALLENGE = EXOTIC_SCROLLS+8;
	public static final int EXOTIC_DEMONICSKULLS = EXOTIC_SCROLLS+9;
	public static final int EXOTIC_UNSPEAKABLE = EXOTIC_SCROLLS+10;
	public static final int EXOTIC_METAMORPHOSIS = EXOTIC_SCROLLS+11;
	static {
	...
	public static final int POTION_HEAL         = POTIONS+1;
	public static final int POTION_MINDVISION   = POTIONS+2;
	public static final int POTION_FROST        = POTIONS+3;
	public static final int POTION_FLAME        = POTIONS+4;
	public static final int POTION_TOXIGGAS     = POTIONS+5;
	public static final int POTION_SPEED        = POTIONS+6;
	public static final int POTION_INVISIBILITY = POTIONS+7;
	public static final int POTION_LEVITAION    = POTIONS+8;
	public static final int POTION_PARALYTICGAS = POTIONS+9;
	public static final int POTION_CLEANSING    = POTIONS+10;
	public static final int POTION_BLESSING     = POTIONS+11;
	...
	public static final int EXOTIC_STRENGTH    = EXOTIC_POTIONS+0;
	public static final int EXOTIC_HEAL        = EXOTIC_POTIONS+1;
	public static final int EXOTIC_MINDVISION  = EXOTIC_POTIONS+2;
	public static final int EXOTIC_FROST       = EXOTIC_POTIONS+3;
	public static final int EXOTIC_FLAME       = EXOTIC_POTIONS+4;
	public static final int EXOTIC_TOXIGGAS    = EXOTIC_POTIONS+5;
	public static final int EXOTIC_SPEED       = EXOTIC_POTIONS+6;
	public static final int EXOTIC_INVISIBILITY= EXOTIC_POTIONS+7;
	public static final int EXOTIC_LEVITAION   = EXOTIC_POTIONS+8;
	public static final int EXOTIC_PARALYTICGAS= EXOTIC_POTIONS+9;
	public static final int EXOTIC_CLEANSING   = EXOTIC_POTIONS+10;
	public static final int EXOTIC_BLESSING    = EXOTIC_POTIONS+11;
	static {
	...
	static{
		...
		assignItemRect(OVERPRICED,  14, 10);
		assignItemRect(CARPACCIO,   15, 11);
		assignItemRect(RATION,      16, 14);
	...
	public static final int TOWERSPAWNER_CAMP          = TOWERSPAWNERS+14;

	static {
		for (int i = TOWERSPAWNERS; i < TOWERSPAWNERS+14; i++)
	...
	public static final int HEROSPELL_GOLDARMOR = HEROSPELLS+3;

	public static final int HEROSPELL_FOCUS = HEROSPELLS + 4;
	public static final int HEROSPELL_TREATWOUNDS = HEROSPELLS + 5;

	public static final int HEROSPELL_SWIFT = HEROSPELLS+6;
	...
	public static final int HEROSPELL_IMMORTALITY = HEROSPELLS+15;
	public static final int HEROSPELL_TELEPORTATION = HEROSPELLS + 16;
	public static final int HEROSPELL_ICEWALL = HEROSPELLS + 17;
	public static final int HEROSPELL_INSIGHT = HEROSPELLS+18;
	public static final int HEROSPELL_PROJECTILES = HEROSPELLS+19;
	public static final int HEROSPELL_OAKSKIN = HEROSPELLS+20;
	public static final int HEROSPELL_REGENERATION = HEROSPELLS+21;
	public static final int HEROSPELL_LASHER = HEROSPELLS+22;
	public static final int HEROSPELL_BANNER = HEROSPELLS+23;
	public static final int HEROSPELL_ARCANESWORD = HEROSPELLS+24;
	public static final int HEROSPELL_BERSERK = HEROSPELLS+25;
	public static final int HEROSPELL_EGOIST = HEROSPELLS+26;
	public static final int HEROSPELL_UNDYING = HEROSPELLS + 27;
	...
	public static class Icons {
		...
		public static final int RING_LETHALITY     = RINGS+12;
		static {
			...
			assignIconRect( RING_LETHALITY,        5, 5 );
		}
		...
		public static final int SCROLL_EVILBAN = EXOTIC_SCROLLS+2;
		public static final int SCROLL_PRISIMG  = EXOTIC_SCROLLS+3;
		public static final int SCROLL_MYSTENRG = EXOTIC_SCROLLS+4;
		public static final int SCROLL_RATKING = EXOTIC_SCROLLS+5;
		public static final int SCROLL_SIREN    = EXOTIC_SCROLLS+6;
		public static final int SCROLL_DISCOVERIES = EXOTIC_SCROLLS+7;
		...
		static {
			...
			assignIconRect(SCROLL_EVILBAN,   7, 7 );
			assignIconRect( SCROLL_PRISIMG,     5, 7 );
			assignIconRect( SCROLL_MYSTENRG,    7, 5 );
			assignIconRect(SCROLL_RATKING,     7, 6 );
			assignIconRect( SCROLL_SIREN,       7, 6 );
			assignIconRect(SCROLL_DISCOVERIES,   7, 5 );
