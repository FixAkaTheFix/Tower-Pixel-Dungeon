...
import com.fixakathefix.towerpixeldungeon.effects.DarkBlock;
...
import com.fixakathefix.towerpixeldungeon.effects.IceBlock;
import com.fixakathefix.towerpixeldungeon.effects.PurpleBlock;
import com.fixakathefix.towerpixeldungeon.effects.RedBlock;
...
import com.fixakathefix.towerpixeldungeon.effects.TorchHalo;
...
import com.fixakathefix.towerpixeldungeon.effects.particles.SnowParticle;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public static final int ORANGE		= 0xFFBB55;
	public static final int YELLOW		= 0xFFFF55;

	public static final int PURPLE		= 0xFF00FF;
	public static final int BLOOD	    = 0xAA0000;

	public static final int GREEN		= 0x009900;
	...
	protected PurpleBlock purpleBlock;
		...
		switch (state) {
			...
			case EATING:
				if (this instanceof HeroSprite){
					play(((HeroSprite)this).operate, true);
				} else play(idle);
				break;
			case FROZEN:
			...
			case DARKENED:
				...
				break;
			case DEMONIC:
				redBlock = RedBlock.doblock(this);
				break;
			case PURPLEDEMONIC:
				purpleBlock = PurpleBlock.doblock(this);
				break;
			case MARKED:
				marked = emitter();
	...
	public void aura( int color, int size, int rays, int angularspeed){
		if (aura != null){
			aura.killAndErase();
		}
		aura = new Flare(rays, size);
