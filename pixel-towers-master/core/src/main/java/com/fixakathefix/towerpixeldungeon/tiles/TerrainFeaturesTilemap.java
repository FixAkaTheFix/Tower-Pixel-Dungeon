...
package com.fixakathefix.towerpixeldungeon.tiles;

import com.fixakathefix.towerpixeldungeon.Assets;
import com.fixakathefix.towerpixeldungeon.Dungeon;
import com.fixakathefix.towerpixeldungeon.levels.LastShopLevel;
...
public class TerrainFeaturesTilemap extends DungeonTilemap {
	...
	public static void setInstance(TerrainFeaturesTilemap instance){
		TerrainFeaturesTilemap.instance = instance;
	}
	...
	public static Image getTrapVisual( Trap trap ){
		...
		Image img = new Image(
				Assets.Environment.TERRAIN_FEATURES
				//instance.texture
		);
		img.frame(uv);
		return img;
