...
import com.fixakathefix.towerpixeldungeon.sprites.GhoulSprite;
	...
	protected boolean act() {
		...
		if (partnerID == -1){
			...
			if (!candidates.isEmpty()){
				...
				Buff b = buff(Minion.class);
				if (b==null) b = buff(MinionBoss.class);
				if (b!=null) Buff.affect(child,b.getClass());
				...
				for (Buff bc : buffs(ChampionEnemy.class)){
					Buff.affect( child, bc.getClass());
				}
