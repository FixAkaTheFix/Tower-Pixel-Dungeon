...
import com.fixakathefix.towerpixeldungeon.sprites.FistSprite;
...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.RING_ELEMENTS, null), Messages.get(RingOfEnergy.class, "name"),
