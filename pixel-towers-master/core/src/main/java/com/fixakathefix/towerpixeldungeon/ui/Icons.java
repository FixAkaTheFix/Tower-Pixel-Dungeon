	...
	public static Image get( Icons type ) {
		...
		switch (type) {
			...
			case FIX:
				...
				break;
			case NECROHERO:
				icon.frame( icon.texture.uvRectBySize( 112, 16, 14, 11 ) );
				break;
			case TANK:
			...
			case SLOT4:
				...
				break;
			case STORYMODE:
				icon.frame( icon.texture.uvRectBySize( 0, 160, 32, 32 ) );
				break;
			case ENDLESSMODE:
				icon.frame( icon.texture.uvRectBySize( 32, 160, 30, 18 ) );
				break;
			case VSMODE:
				icon.frame( icon.texture.uvRectBySize( 62, 160, 44, 33 ) );
				break;
			case REDPORTAL:
				icon.frame( icon.texture.uvRectBySize( 106, 160, 17, 28 ) );
				break;
		}
		return icon;
	}
