...
import com.fixakathefix.towerpixeldungeon.sprites.DM300Sprite;
...
public class v0_8_X_Changes {
	...
	public static void add_v0_8_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_ELEMENTS), Messages.get(RingOfEnergy.class, "name"),
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_LETHALITY), Messages.get(RingOfWealth.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.RING_LETHALITY), "Ring of Wealth and Lucky Enchant",
	...
	public static void add_v0_8_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		if (DeviceCompat.isDesktop()) {
			...
			changes.addButton( new ChangeButton( new ItemSprite(ItemSpriteSheet.SCROLL_TRANSMUTATION, null), "Update Notification",
