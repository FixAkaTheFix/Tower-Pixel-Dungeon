...
import com.fixakathefix.towerpixeldungeon.ui.BadgesList;
...
import com.fixakathefix.towerpixeldungeon.ui.ItemSlot;
	...
	private class StatsTab extends Group {
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				pos = statSlot(this, Messages.get(this, "sneakattacks"), num.format((int) Statistics.sneakAttacks), pos);
				pos = statSlot(this, Messages.get(this, "thrownattacks"), num.format((int) Statistics.thrownAttacks), pos);
				pos = statSlot(this, Messages.get(this, "upgrades"), num.format((int) Statistics.upgradesUsed), pos);

				pos += GAP;

				pos = statSlot(this, Messages.get(this, "potions"), num.format((int) Statistics.potions), pos);
				pos = statSlot(this, Messages.get(this, "scrolls"), num.format((int) Statistics.scrolls), pos);
				pos = statSlot(this, Messages.get(this, "food"), num.format(Statistics.foodEaten), pos);

				pos += GAP;

				pos = statSlot(this, Messages.get(this, "towersbuilt"), num.format((int) Statistics.towersbuilt), pos);
				pos = statSlot(this, Messages.get(this, "walls"), num.format((int) Statistics.wallsdestroyed), pos);
				pos = statSlot(this, Messages.get(this, "notwalls"), num.format((int) Statistics.notwallsdestroyed), pos);
