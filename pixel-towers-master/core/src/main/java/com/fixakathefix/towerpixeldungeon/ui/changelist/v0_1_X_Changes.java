...
public class v0_1_X_Changes {
	...
	public static void add_v0_1_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_SKULLS, null), "Misc Item Changes",
				"Sungrass buffed:\n" +
	...
	public static void add_v0_1_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.POTION_CLEANSING, null), "Potion Changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.SCROLL_SKULLS, null), "Scroll Changes",
