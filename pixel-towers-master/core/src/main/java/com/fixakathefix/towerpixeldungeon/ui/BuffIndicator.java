...
import com.fixakathefix.towerpixeldungeon.windows.WndInfoBuff;
...
public class BuffIndicator extends Component {
	...
	public static final int WAVE        = 101;

	public static final int STRENGTH    = 102;
	...
	public static final int MINION  = 108;
	public static final int MINIONBOSS  = 109;
	public static final int PREDICTION  = 110;
	public static final int EATING  = 111;
	public static final int SOULBLEEDING  = 112;
	public static final int WATCHED  = 113;

	public static final int WALLSTANCE  = 114;
	public static final int INSPIRED    = 115;
	...
	public static final int HIGHLIGHTED    = 120;
