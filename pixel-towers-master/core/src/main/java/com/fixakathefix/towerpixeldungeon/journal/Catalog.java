...
import com.fixakathefix.towerpixeldungeon.items.bags.PotionBandolier;
import com.fixakathefix.towerpixeldungeon.items.bags.ScrollHolder;
import com.fixakathefix.towerpixeldungeon.items.bags.VelvetPouch;
import com.fixakathefix.towerpixeldungeon.items.bombs.ArcaneBomb;
...
import com.fixakathefix.towerpixeldungeon.items.food.ChargrilledMeat;
...
import com.fixakathefix.towerpixeldungeon.items.quest.DwarfToken;
...
public enum Catalog {
	...
	static {
		...
		ARMOR.addItems(ClothArmor.class, LeatherArmor.class, MailArmor.class, ScaleArmor.class, PlateArmor.class);
		...
		MISC_EQUIPMENT.addItems(BrokenSeal.class, SpiritBow.class, Waterskin.class, Amulet.class);
		...
		SCROLLS.addItems(ExoticScroll.exoToReg.keySet().toArray(new Class[0]));
		...
		SPELLS.addItems(WildEnergy.class, TelekineticGrab.class, PhaseShift.class,
				Alchemize.class, CurseInfusion.class, Recycle.class,
				ReclaimTrap.class, SummonElemental.class, BeaconOfReturning.class);

		MISC_CONSUMABLES.addItems(Stylus.class, Torch.class, Honeypot.class, Ankh.class,
				CorpseDust.class, CeremonialCandle.class, DarkGold.class, DwarfToken.class,
				GooBlob.class, MetalShard.class, LiquidMetal.class, ArcaneResin.class);
