...
public class Statistics {
	public static int maxLevelDeveloped = 21;
	...
	public static int wallsdestroyed;
	public static int notwallsdestroyed;
	...
	private static final String NONWALLS		= "nonwalls";
	private static final String TOWERSBUILT		= "towersbuilt";
	...
	public static void storeInBundle( Bundle bundle ) {
		...
		bundle.put( WALLS ,     wallsdestroyed);
		bundle.put( NONWALLS ,  notwallsdestroyed);
		bundle.put( POTIONS ,     potions);
		bundle.put( SCROLLS,  scrolls);
		bundle.put(TOWERSBUILT, towersbuilt);
	...
	public static void restoreFromBundle( Bundle bundle ) {
		...
		wallsdestroyed = bundle.getInt(WALLS);
		notwallsdestroyed = bundle.getInt(NONWALLS);
		towersbuilt = bundle.getInt(TOWERSBUILT);
