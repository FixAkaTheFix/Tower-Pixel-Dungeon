...
public class HeroAction {
	...
	public static class Move extends HeroAction {
		public Move( int dst ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "move to (" + dst%Dungeon.level.width()+ ";" + dst/Dungeon.level.width()+")" );
			this.dst = dst;
		}
	}
	...
	public static class PickUp extends HeroAction {
		public PickUp( int dst ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "pick up");
			this.dst = dst;
		}
	}
	...
	public static class OpenChest extends HeroAction {
		public OpenChest( int dst ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "open chest");
			this.dst = dst;
		}
	}
	...
	public static class Buy extends HeroAction {
		public Buy( int dst ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "buy");
			this.dst = dst;
		}
	}
	...
	public static class Interact extends HeroAction {
		...
		public Interact( Char ch ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "interact");
			this.ch = ch;
		}
	}
	...
	public static class Attack extends HeroAction {
		...
		public Attack( Char target ) {
			if (DeviceCompat.isDebug()) DeviceCompat.log( "HERO ACTIONS", "attack");
			this.target = target;
		}
	}
}
