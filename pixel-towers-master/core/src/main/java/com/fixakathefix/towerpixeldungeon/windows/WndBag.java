...
import com.fixakathefix.towerpixeldungeon.ui.InventorySlot;
...
public class WndBag extends WndTabbed {
	...
	protected static int SLOT_WIDTH_L   = 17;

	protected static int SLOT_HEIGHT_P	= 17;
	...
	public WndBag( Bag bag, ItemSelector selector ) {
		...
		nRows = (int)Math.ceil(45/(float)nCols); //we expect to lay out 45 slots in all cases
