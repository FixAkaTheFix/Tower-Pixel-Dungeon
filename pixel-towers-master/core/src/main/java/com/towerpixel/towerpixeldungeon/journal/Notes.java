...
import com.towerpixel.towerpixeldungeon.actors.blobs.Foliage;
import com.towerpixel.towerpixeldungeon.actors.blobs.SacrificialFire;
import com.towerpixel.towerpixeldungeon.actors.blobs.WaterOfAwareness;
import com.towerpixel.towerpixeldungeon.actors.blobs.WaterOfHealth;
...
import com.towerpixel.towerpixeldungeon.actors.mobs.npcs.ImpShopkeeper;
...
import com.towerpixel.towerpixeldungeon.levels.rooms.special.WeakFloorRoom;
import com.towerpixel.towerpixeldungeon.messages.Messages;
import com.towerpixel.towerpixeldungeon.scenes.PixelScene;
import com.towerpixel.towerpixeldungeon.sprites.BlacksmithSprite;
import com.towerpixel.towerpixeldungeon.sprites.GhostSprite;
import com.towerpixel.towerpixeldungeon.sprites.ImpSprite;
...
import com.towerpixel.towerpixeldungeon.sprites.SpawnerSprite;
	...
	public static class LandmarkRecord extends Record {
		...
		public Image icon(){
			switch (landmark){
				...
				case CHASM_FLOOR:
					return Icons.DEPTH_CHASM.get();
				case WATER_FLOOR:
					return Icons.DEPTH_WATER.get();
				case GRASS_FLOOR:
					return Icons.DEPTH_GRASS.get();
				case DARK_FLOOR:
					return Icons.DEPTH_DARK.get();
				case LARGE_FLOOR:
					return Icons.DEPTH_LARGE.get();
				case TRAPS_FLOOR:
					return Icons.DEPTH_TRAPS.get();
				case SECRETS_FLOOR:
					return Icons.DEPTH_SECRETS.get();
