...
public class Badges {
	...
	public enum Badge {
		...
		BOSS_SLAIN_1_FIX,
		OOZE_SLAIN_ALL_CLASSES( 54, true ),
	...
	static {
		...
		firstBossClassBadges.put(HeroClass.FIX, Badge.BOSS_SLAIN_1_FIX);
	}
	...
	static {
		...
		victoryClassBadges.put(HeroClass.FIX, Badge.VICTORY_FIX);
	}
	...
	static {
		...
		thirdBossSubclassBadges.put(HeroSubClass.ALPHA, Badge.BOSS_SLAIN_3_ALPHA);
		thirdBossSubclassBadges.put(HeroSubClass.BETA, Badge.BOSS_SLAIN_3_BETA);
	}
	...
	public static void validateBossSlain() {
		...
		case 5:
			badge = Badge.OOZE_SLAIN;
			break;
		case 10:
			badge = Badge.TENGU_SLAIN;
			break;
		case 15:
			badge = Badge.CAVES_BEATEN;
			break;
		case 20:
		...
		if (badge != null) {
			...
			if (badge == Badge.OOZE_SLAIN) {
				...
				if (allUnlocked) {
					...
					badge = Badge.OOZE_SLAIN_ALL_CLASSES;
					if (!isUnlocked( badge )) {
						displayBadge( badge );
					}
				}
			} else if (badge == Badge.CAVES_BEATEN) {
	...
	private static final Badge[][] tierBadgeReplacements = new Badge[][]{
			...
			{Badge.OOZE_SLAIN, Badge.TENGU_SLAIN, Badge.CAVES_BEATEN, Badge.BOSS_SLAIN_4},
	...
	private static final Badge[][] prerequisiteBadges = new Badge[][]{
			{Badge.OOZE_SLAIN, Badge.BOSS_CHALLENGE_1},
			{Badge.TENGU_SLAIN, Badge.BOSS_CHALLENGE_2},
			{Badge.CAVES_BEATEN, Badge.BOSS_CHALLENGE_3},
