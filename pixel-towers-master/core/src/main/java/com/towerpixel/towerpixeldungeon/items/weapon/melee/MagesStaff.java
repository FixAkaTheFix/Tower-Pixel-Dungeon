...
public class MagesStaff extends MeleeWeapon {
	...
	public int max(int lvl) {
		return  Math.round(10f*(damageModifier()+1) +   //6 base damage, down from 10
				lvl*(damageModifier()+1));               //scaling unaffected
	}

	@Override
	public int min(int lvl) {
		return  Math.round(4f*(damageModifier()+1) +   //6 base damage, down from 10
