...
public class GamesInProgress {
	...
	public static void set(int slot) {
		...
		info.critChance = (int)((Dungeon.hero.critChance*100) + (Dungeon.hero.belongings.weapon==null ? 0 : Dungeon.hero.belongings.weapon.critChance*100));
		info.critMult= (int)((Dungeon.hero.critMult*100) *(Dungeon.hero.belongings.weapon==null ? 0 : Dungeon.hero.belongings.weapon.critMult));
