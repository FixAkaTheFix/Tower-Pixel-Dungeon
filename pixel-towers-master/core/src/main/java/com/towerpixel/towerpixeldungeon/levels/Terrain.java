...
public class Terrain {
	...
	public static final int ADDITIONALBARRIER = 32;
	...
	public static final int HEROUNPASSABLE  = 0x100;
	...
	static {
		...
		flags[WELL]			= AVOID;
		flags[STATUE]		= SOLID | HEROUNPASSABLE ;
		flags[STATUE_SP]	= SOLID | HEROUNPASSABLE;
		flags[BOOKSHELF]	= flags[BARRICADE] ;
		flags[ALCHEMY]		= SOLID | HEROUNPASSABLE;
