...
import com.towerpixel.towerpixeldungeon.windows.WndHeroInfo;
...
import com.towerpixel.towerpixeldungeon.windows.WndTextInput;
...
public class HeroSelectScene extends PixelScene {
	...
	public void create() {
		...
		if (DeviceCompat.isDebug() || true){ // Badges.isUnlocked(Badges.Badge.VICTORY)){
			add(btnOptions);
		} else {
